...
def query_gpt_model(
    ...
    mpath_base = mpath.stem # only want the base name of the model folder for check below
    ...
    try:
        ...
        if verbose:
            print("------------------------diff list: ")
            pp.pprint(diff_list)  # where diff_list is only the text generated by the model
            print("---------------------------------")
