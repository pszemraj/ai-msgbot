...
if __name__ == "__main__":
    ...
    if "gpt2_275k_checkpoint" not in folder_names: utils.get_zip_URL(model_links["gpt335M_275ks_checkpoint"],
                                                                     extract_loc=os.getcwd())
    if "gpt-neo_datasetv2" not in folder_names: utils.get_zip_URL(model_links["gpt-neo-125M_150ks_checkpoint"],
                                                                     extract_loc=os.getcwd())
