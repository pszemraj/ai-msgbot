...
def parse_whatsapp(text_path, verbose=False):
    ...
    if verbose: print("exiting the function have {} lines".format(len(fin_text)))
    return fin_text


# Set up the parsing of command-line arguments
parser = argparse.ArgumentParser(description="convert whatsapp chat exports to GPT-2 input")
